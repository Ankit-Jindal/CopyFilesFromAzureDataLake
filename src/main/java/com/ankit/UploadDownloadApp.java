...
public class UploadDownloadApp {
    ...
    private static String clientId = "a45a25d0-e556-4b87-b9df-6f61e664d02e"; // "76ca35ac-2d18-46c8-8ee1-c67bd810aeba"; //[User Object ID]
    private static String authTokenEndpoint = "https://login.microsoftonline.com/io-tahoe.com/oauth2/token";
    private static String clientKey = "71O0c/YDR5276LCDVqILXryhOKgsixw0nEGf8PdVNpA=";
